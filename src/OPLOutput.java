...
/**
 * Handles the output of election results for OPL. Extends
 * the {@code Output} class to provide specific implementations for displaying results in the
 * console and writing them to an audit file for OPL's format
 * @author Bao Ha, Riandy Setiady, Vivian Tsang, Michael Diep
 * @version 1.0
 * @since 1.0
 */
public class OPLOutput extends Output{
    /**
     * Constructs an {@code OPLOutput} object associated with a specific {@code Voting} instance,
    ...
    public void displayResults() {
        ...
        System.out.println("Election Type: OPL");
    ...
    public void makeAudit(){
        try {
            ...
            writer.println("Election Type: OPL");
